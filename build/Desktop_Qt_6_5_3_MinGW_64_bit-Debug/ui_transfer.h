...
public:
    ...
    void setupUi(QWidget *Transfer)
    {
        ...
        upload_scroll->setGeometry(QRect(0, 0, 765, 525));
        ...
        download_scroll->setGeometry(QRect(0, 0, 765, 525));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 765, 525));
        ...
        record_msg->setFrameShape(QFrame::Shape::NoFrame);
