...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTransferENDCLASS_t qt_meta_stringdata_CLASSTransferENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 16),  // "currentTabSignal"
        QT_MOC_LITERAL(26, 0)   // ""
    },
    "Transfer",
    "currentTabSignal",
...
void Transfer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->currentTabSignal((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Transfer::*)(QString );
            if (_t _q_method = &Transfer::currentTabSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
